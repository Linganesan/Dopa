...
/**
public class Add_Update_Loci extends Activity {
	...
	if (called_from.equalsIgnoreCase("add")) {
	    ...
	    Loci loci = dbHandler.getContact(USER_ID);

	    add_name.setText(loci.getName());
	    add_image.clone();
		Intent intnt = getIntent();
		theImage = (Bitmap)loci.getImage();
	...
	update_btn.setOnClickListener(new View.OnClickListener() {
		...
		if (valid_name != null && valid_mob_number != null
		    ...
		    dbHandler.Update_Contact(new Loci(USER_ID, valid_name,img
			    ));
		    dbHandler.close();
