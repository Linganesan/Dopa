...
/**
 * Entity mapped to table "DISCIPLINE_NUMBER_LIST".
 */
public class Discipline_number_list {
    ...
    private transient Discipline_number_listDao myDao;

    private Discipline discipline;
    private Long discipline__resolvedKey;


    public Discipline_number_list() {
    }

    public Discipline_number_list(Long id) {
        this.id = id;
    }

    public Discipline_number_list(Long id, long disciplineId, long item) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getDiscipline_number_listDao() : null;
    }
