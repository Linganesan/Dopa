...
/**
 * Entity mapped to table "LOCUS_IMAGE_LIST".
 */
public class Locus_image_list {
    ...
    private transient Locus_image_listDao myDao;

    private Locus locus;
    private Long locus__resolvedKey;


    public Locus_image_list() {
    }

    public Locus_image_list(Long id) {
        this.id = id;
    }

    public Locus_image_list(Long id, long locusId, byte[] item) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getLocus_image_listDao() : null;
    }
